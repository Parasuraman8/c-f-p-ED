...
public class EdJwtConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable().exceptionHandling()
                ...
                .authorizeRequests().antMatchers("/ED/OfficerController/createOfficer","/ED/AdminController/createAdmin","/ED/EdJwtController/login","/ED/UserController/createEdUser","/swagger-ui/**", "/swagger-resources/**", "/v2/api-docs").permitAll().anyRequest().authenticated();
