...
import { CREATE_ED_ADMIN, CREATE_ED_ROLE, GET_ADMIN_BY_ID, GET_ALL_ADMIN, GET_ALL_ROLE, GET_ROLE_BY_ID, GET_USER_CREDENTIAL, MODIFY_ED_ROLE, MODIFY_USER_CREDENTIAL } from '../comman/constant';
